...
import { Eye, EyeOff, User, Lock, LogIn, AlertCircle, Shield } from 'lucide-react';
...
const AdminLogin = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gray-50">
      {/* Main background with gradient - using a different shade of blue for admin */}
      <div 
        ...
        >
          <div className="p-8">
            ...
            >
              ...
              <p className="mb-8" style={{ color: '#2c5282' }}>Sign in to access administrative controls</p>
            </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <User className="h-5 w-5" style={{ color: '#2c5282' }} />
                  </div>
                  <motion.input
                    whileFocus={{ scale: 1.01, boxShadow: '0 0 0 3px rgba(44, 82, 130, 0.2)' }}
                    ...
                    disabled={isLoading}
                    className="pl-10 block w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-700 placeholder-gray-400 transition-all duration-200 focus:border-[#2c5282] focus:ring-2 focus:ring-[#2c5282] focus:ring-opacity-20"
              ...
              >
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Lock className="h-5 w-5" style={{ color: '#2c5282' }} />
                  </div>
                  <motion.input
                    whileFocus={{ scale: 1.01, boxShadow: '0 0 0 3px rgba(44, 82, 130, 0.2)' }}
                    transition={{ type: "spring", stiffness: 300 }}
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.1, color: '#2c5282' }}
                    whileTap={{ scale: 0.95 }}
                  >
                    {showPassword ? (
              ...
              >
                <motion.button
                  whileHover={{ scale: 1.03, boxShadow: '0 10px 15px -3px rgba(44, 82, 130, 0.3)' }}
                  whileTap={{ scale: 0.97 }}
                  type="submit"
                  disabled={isLoading}
